...
| Skill | Purpose |
|---|---|
| [investment-research](investment-research/SKILL.md) | PhD-level investment research analyst for the self-directed investor (finance + data-engineering background) — researches and compares vehicles and accounts, portfolio construction and risk, costs/taxes/behaviour, and reproducible research/backtesting pipelines. Education and analysis, not licensed advice or trade execution; hands off active trading to discretionary-trading-assistant. Bundles a portfolio analyzer and a fee-drag projection tool. |
